...
/**
 * This file contains methods to create an Oracle Content SDK client to make calls to the
 * Oracle Content. A "delivery client" is used to view content which has been published to a public
